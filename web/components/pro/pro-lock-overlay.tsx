    ...
    <>
      ...
      >
        ...
        <div className="pointer-events-none fixed inset-0 z-10 flex items-center justify-center px-4 md:left-[14.25rem]">
          <div className="pointer-events-auto relative w-full max-w-[320px] rounded-2xl border border-primary/30 bg-white px-6 py-7 text-center ring-1 ring-primary/20 shadow-xl shadow-primary/10 sm:max-w-[340px] before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-b before:from-transparent before:via-transparent before:to-gray-400/20 before:pointer-events-none">
