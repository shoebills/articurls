...
import { Check, Moon, Sun, Monitor, Pipette } from "lucide-react";
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                <span className={`text-xs font-medium ${theme === "custom" ? "text-foreground font-semibold" : "text-muted-foreground"}`}>
                  Custom
                </span>
              </button>
            </PopoverTrigger>
