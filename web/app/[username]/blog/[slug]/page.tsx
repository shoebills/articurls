            ...
            <div className="sm:hidden">
              <div className="relative flex items-center justify-between gap-3">
                ...
                <details className="group static">
                  <summary className="flex h-9 w-9 list-none items-center justify-center rounded-md border border-border/70 bg-background/95 text-muted-foreground shadow-md shadow-black/10 transition-all duration-200 hover:bg-background hover:text-foreground group-open:border-primary/30 group-open:bg-primary/[0.08] group-open:text-primary [&::-webkit-details-marker]:hidden">
