        ...
        <CardContent>
          {done ? (
            <div className="space-y-4">
              <p className="rounded-xl border border-emerald-300/60 bg-emerald-50/50 px-4 py-3 text-sm leading-relaxed text-emerald-900">
            ...
            <div className="space-y-4">
              <p className="rounded-xl border border-amber-300/60 bg-amber-50/60 px-4 py-3 text-sm leading-relaxed text-amber-900">
